  ...
  return (
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-50 px-4 md:px-10">
      <div className="navbar w-full h-full flex flex-row items-center justify-between m-auto">
        ...
        {/* Center Nav Links */}
        <div className=" mt-5 md:mt-0 md:flex w-auto h-full items-center justify-between md:mr-20">
          <div className="flex items-center space-x-6 border md:border-[#7042f861] md:bg-[#0300145e] px-4 py-2 rounded-full text-gray-200 text-sm">
